...
//}
//
//print("\(beforemonth)월 \(beforeday)일부터 100일 후는 \(aftermonth)월 \(afterday)일 입니다.")
...
//let untitled2 = Untitled2()
//
//print("합계 : ", sum)
//print(untitled.printRun())
//print(untitled2.printRun())
...
print("며칠 후?: ", terminator: "")
remainday = Int(readLine() ?? "") ?? 0
...
print("\(beforemonth)월 \(beforeday)일부터 \(remainday)일 후는 \(aftermonth)월 \(afterday)일 입니다.")
